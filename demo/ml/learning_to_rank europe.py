############################################################################
### QPMwP CODING EXAMPLES - LEARNING TO RANK (LTR) - EUROPE DATA
############################################################################

# --------------------------------------------------------------------------
# Cyril Bachelard
# This version:     11.05.2026
# First version:    11.05.2026
# --------------------------------------------------------------------------
...
data_path = Path('C:/Users/User/OneDrive/Documents/QPMwP/Data/Europe')
...
daily_ret.dropna().to_frame().to_parquet('C:/Users/User/OneDrive/Documents/QPMwP/Data/Europe/return_series.parquet')
...
signals.to_parquet('C:/Users/User/OneDrive/Documents/QPMwP/Data/Europe/signals.parquet')
...
if Path(feature_path).exists() and not feature_recompute:
    ...
    # load signals
    X = pd.read_parquet(path=data_path / "signals.parquet")
    # X = X[feature_cols]
